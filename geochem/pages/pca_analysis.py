...
pca_analysis_layout = dbc.Container([
    dbc.Row([
        dbc.Col(html.Div([
            ...
            html.P([html.Strong("o Rows"), "represent your original geochemical variables (e.g., Ba, Co, Cr)."]),
            html.P([html.Strong("o Columns"), "represent the principal components (PC1, PC2, etc.)."]),
            html.P([html.Strong("o Colors and Values: "), "The color and the number in each cell indicate the 'loading' of that variable on that principal component."]),
            html.P(html.Ul([
...
def register_pca_analysis_callbacks(app):
    """Register callbacks for lazy loading support."""
    return pca_analysis_callbacks(app)